...
class HorariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create horario" do
    assert_difference('Horario.count') do
      post horarios_url, params: { horario: { Hor_Dia: @horario.Hor_Dia, Hor_Hora_Fin: @horario.Hor_Hora_Fin, Hor_Hora_Inicio: @horario.Hor_Hora_Inicio, medico_id: @horario.medico_id } }
    end
  ...
  test "should update horario" do
    patch horario_url(@horario), params: { horario: { Hor_Dia: @horario.Hor_Dia, Hor_Hora_Fin: @horario.Hor_Hora_Fin, Hor_Hora_Inicio: @horario.Hor_Hora_Inicio, medico_id: @horario.medico_id } }
